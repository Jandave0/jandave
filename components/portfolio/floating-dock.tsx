...
export function FloatingDock() {
  return (
    <aside
      ...
      className="fixed bottom-3 sm:bottom-5 left-1/2 -translate-x-1/2 z-50 max-w-[calc(100vw-1rem)] px-1 sm:px-2 pointer-events-auto"
    >
      <Dock
...
export { FloatingDock as AppleStyleDock, FloatingDock as FloatingDockMagic };
